...
def test_create_profession(mocker, fixture_profession_developer):
    ...
    presenter_mock = mocker.patch.object(CreateProfessionPresenterInterface, "present")
    repository_mock = mocker.patch.object(ProfessionRepositoryInterface, "create")
    ...
    use_case = create_profession.CreateProfessionUseCase(
        presenter_mock, repository_mock
    )
