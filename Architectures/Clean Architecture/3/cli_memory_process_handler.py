...
from src.app.cli_memory.interfaces.cli_memory_controller_interface import (
    CliMemoryControllerInterface,
)
from src.app.cli_memory.controllers.exit_controller import ExitController
from src.app.cli_memory.controllers.create_profession_controller import (
...
class CliMemoryProcessHandler:
    ...
    def add_option(self, option: str, controller: CliMemoryControllerInterface) -> None:
    ...
    def execute(self) -> None:
        ...
        while True:
            ...
            if option:
                try:
                    option.execute()
                except (ValueError, FieldValueNotPermittedException) as exception:
                    print(f"\nERROR: {str(exception)}\n")
